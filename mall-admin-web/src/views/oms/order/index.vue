      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="订单编号*：">
            <el-input v-model="listQuery.orderSn" class="input-width" placeholder="订单编号(必填)"></el-input>
          </el-form-item>
          <el-form-item label="客户ID*：">
            <el-input v-model="listQuery.memberId" class="input-width" placeholder="客户ID(必填)"></el-input>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleSearchList() {
        if(!this.listQuery.orderSn && !this.listQuery.memberId){
          this.$message({
            message: '订单编号和客户ID至少要输入一项',
            type: 'warning',
            duration: 1000
          });
        }else{
