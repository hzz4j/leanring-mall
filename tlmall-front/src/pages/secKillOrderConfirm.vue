...
export default{
  ...
  methods:{
    ...
    getCartList(){
        ...
        var confirmOrderurl = '/cart/'+this.token+'/generateConfirmOrder';
       this.axios.post(confirmOrderurl,Qs.stringify({productId: this.id},{indices: false}),
    ...
    this.axios.post('/cart/'+this.token+'/generateOrder',{
